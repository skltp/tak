<html>
    <head>
        <title><g:message code="application.title" default="Welcome to TP 1.2.0" /></title>
		<meta name="layout" content="main" />
    </head>
    <body>
        <h1 style="margin-left:20px;"><g:message code="application.title" default="Welcome to TP 1.2.0" /></h1>
        <p style="margin-left:20px;width:80%"><g:message code="application.description"
        default="This is the Administration Application for the Service Catalogue of TP 1.2.0" /></p>
        <br/>
        <hr/>
        <br/>
