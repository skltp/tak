...
<html>
	...
	<body>
		<a href="#edit-tjanstekontrakt" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-tjanstekontrakt" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${tjanstekontraktInstance?.version}" />
				<fieldset class="form">
