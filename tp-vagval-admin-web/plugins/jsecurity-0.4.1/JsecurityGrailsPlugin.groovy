...
'''
    ...
    def doWithSpring = {
        ...
        application.realmClasses.each { realmClass ->
            ...
            // The bean definitions are provided by the configureRealm
            // closure.
            realmBeans << c(realmClass)
        }
...
//        'org.jsecurity.spring.LifecycleBeanPostProcessor'(org.jsecurity.spring.LifecycleBeanPostProcessor)
        ...
        jsecSecurityManager(DefaultWebSecurityManager) { bean ->
            ...
            // JSecurity doesn't like an empty collection of realms,
            // so we only configure the "realms" property if there are
            // some.
    ...
    def doWithApplicationContext = { applicationContext ->
        ...
        if (mgr.realms == null){
            ...
            if (!realms) {
                log.warn "No JSecurity realms configured - access control won't work!"
            }
            else {
                mgr.realms = realms
            }
