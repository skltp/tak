...
<html>
	...
	<body>
		<a href="#edit-pubVersion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-pubVersion" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${pubVersionInstance?.version}" />
				<fieldset class="form">
