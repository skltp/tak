...
<body>
<a href="#delete-logiskAdress" class="skip" tabindex="-1">
...
<div id="delete-logiskAdress" class="content scaffold-delete" role="main">
    <h1>
        <g:message code="logiskAdress.bulkdelete.label" />
    </h1>
    ...
    <g:form action="bulkdeletevalidate">
        <fieldset class="form">
            ...
            <div class="fieldcontain ${hasErrors(field: 'logiskAdressBulk', 'error')} required">
                <label for="logiskAdressBulk">
                    <g:message code="logiskaAdresserBulkDelete.label" />
        ...
        <fieldset class="buttons">
            <g:submitButton name="validate" class="delete" value="${message(code:'button.validate.label')}" />
        </fieldset>
    </g:form>
</div>
</body>
