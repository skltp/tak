...
<html>
	...
	<body>
		<a href="#edit-rivTaProfil" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-rivTaProfil" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${rivTaProfilInstance?.version}" />
				<fieldset class="form">
