...
<div class="fieldcontain ${hasErrors(bean: tjanstekontraktInstance, field: 'beskrivning', 'error')} ">
 ...
 <g:textArea name="beskrivning" cols="40" rows="5" maxlength="255"
  value="${tjanstekontraktInstance?.beskrivning}" />
</div>
...
<g:if test="${tjanstekontraktInstance.id}">
 <div class="fieldcontain ${hasErrors(bean: tjanstekontraktInstance, field: 'anropsbehorigheter', 'error')} required">
  ...
  <ul class="one-to-many">
   ...
   <li class="add">
    <g:link controller="anropsbehorighet" action="create" params="['tjanstekontrakt.id': tjanstekontraktInstance?.id]">
     ${message(code: 'default.add.label', args: [message(code: 'anropsbehorighet.label', default: 'Anropsbehorighet')])}
    </g:link>
   </li>
  </ul>
 </div>
...
<g:if test="${tjanstekontraktInstance.id}">
 <div class="fieldcontain ${hasErrors(bean: tjanstekontraktInstance, field: 'vagval', 'error')} required">
  <label for="vagval"> 
  ...
  <ul class="one-to-many">
   ...
   <li class="add">
    <g:link controller="vagval" action="create" params="['tjanstekontrakt.id': tjanstekontraktInstance?.id]">
     ${message(code: 'default.add.label', args: [message(code: 'vagval.label')])}
    </g:link>
   </li>
  </ul>
 </div>
